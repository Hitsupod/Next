          ...
          <Col md="4">
            ...
            >
              <Card.Body>
                ...
                <Button href="https://www.amazon.com/Tom-Clancys-Division-PS4-playstation-4/dp/B07BMPVG1S/ref=sr_1_1?crid=3UVKLRD945M6M&dchild=1&keywords=the+division+2+ps4&qid=1601251653&s=videogames&sprefix=the+division%2Cvideogames%2C189&sr=1-1">
                  Amazon
                </Button>{" "}
          ...
          <Col md="4">
            ...
            >
              <Card.Body>
                ...
                <Card.Title className="questions">Battlefield V</Card.Title>
                <Card.Text className="questions">
                  Battlefield V is focused extensively on party-based features
                  and mechanics, scarcity of resources, and removing
                  "abstractions" from game mechanics to increase realism. There
                  is an expanded focus on player customization through the new
                  Company system, where players can create multiple characters
                  with cosmetic and weapon options. Cosmetic items, and currency
                  used to purchase others, are earned by completing in-game
                  objectives.
                </Card.Text>
                <Button href="https://www.amazon.com/Battlefield-V-PlayStation-4/dp/B07D767FMV/ref=sr_1_2?dchild=1&keywords=battlefield+v+ps4&qid=1601250747&sr=8-2">
                  Amazon
                </Button>{" "}
                <Button type="submit">Save</Button>{" "}
              </Card.Body>
